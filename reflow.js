...
var reflow = function() {
	...
	if (mobilecheck()) {
		...
		// Education
		if (schools) {
			schools.style.flexDirection = "column";
			schools.style.justifyContent = "space-around";
		}
		if (school) {
			for (var i = 0; i < school.length; i++) {
				school[i].style.width = "100%";
			}
		}
		if (educationH1) {
			for (var i = 0; i < educationH1.length; i++) {
				educationH1[i].style.fontSize = "1.5em";
			}
		}
		if (educationH2) {
		...
		if (educationH1) {
			for (var i = 0; i < educationH1.length; i++) {
				educationH1[i].style.fontSize = "2em";
			}
		}
		if (educationH2) {
			for (var i = 0; i < educationH2.length; i++) {
		...
		// Education
		if (schools) {
			schools.style.flexDirection = "row";
			schools.style.justifyContent = "space-around";
		}
		if (school) {
			for (var i = 0; i < school.length; i++) {
				school[i].style.width = "50%";
			}
		}
		if (educationH1) {
			for (var i = 0; i < educationH1.length; i++) {
