        ...
        <div id="page_wrapper">
            ...
            <div id="body_wrapper">
                <div id="container" style="text-align: center;">
                    ...
                    <form action="contactForm.php" method="post" style="margin-left: auto; margin-right: auto; display: inline-block; background-color: #CCCCCC; border-radius: 5px; margin-top: 20px; padding: 20px;">
