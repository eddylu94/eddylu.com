      ...
      <div id="body_wrapper">
        <div id="container">
          ...
          <div class="blog-story" style="line-height: 1.50; margin-top: 50px">
            ...
            <p>This is due to the fact that, even when the ultimate goal is to develop a mobile app, it can be difficult to receive feedback from friends/testers
            as they would have to either download the mobile application or load the application via a mobile test tool (ex. <a target="_blank" href="https://developer.apple.com/testflight/">TestFlight</a>).
            Therefore, I frequently find it easier to quickly hack up prototypes as React web apps and then, after enough user feedback and development iterations,
            convert the web app into a mobile app.</p>
            ...
            For example, as per the Lean Startup principal, startup app projects should be as simple as possible;
            developers should seek user feedback and iterate constantly off of the simple prototype.</p>
            ...
            <p>Implementing a web app prior to converting to mobile can be time consuming;
            at some point, developers need to decide whether they should continue to maintain the web application or discontinue the web app development.</p>
            ...
            <p>The following are common syntactical differences I have stumbled upon when using React and React Native:</p>
            ...
            <p>In React, button content/text is centered by default;
            in React Native, the content is naturally aligned in the top-left of the <a target="_blank" href="https://reactnative.dev/docs/button">Button</a> component.</p>
            ...
            <p>Button-type components in React Native, such as <a target="_blank" href="https://reactnative.dev/docs/touchablehighlight">TouchableHighlight</a>,
            can only contain one child component.</p>
...
&lt;/TouchableHighlight&gt;
            ...
            <span class="caption">A common solution for ensuring single child elements for TouchableHighlight is to use
            <a target="_blank" href="https://reactjs.org/docs/fragments.html">fragments</a></span>

            <h2>Text</h2>

            <p>In React Native, text has to be wrapped by the <a target="_blank" href="https://reactnative.dev/docs/text">Text</a> component;
            this includes text used in buttons/containers.</p>
...
&lt;/div&gt;
            ...
            <p>In React/HTML, <a target="_blank" href="https://developer.mozilla.org/en-US/docs/Web/CSS/CSS_Flexible_Box_Layout/Basic_Concepts_of_Flexbox">flexboxes</a> use horizontal, or "row", orientation by default.
            In React Native, flexboxes use vertical, or "column", orientation by default.</p>
            ...
            <p>In React Native, the Image component source uses either <em>uri</em> with an image path, or an import (ex. via <em>require</em>).</p>
...
&lt;Image src={{uri: 'hello.png'}} /&gt;
            ...
            <p>In React, without third-party libraries, styles can be applied to elements using in-line styles or classes from stylesheets;
            React Native does not support styles added via classes.</p>

            <h2>Value Types</h2>

            <p>In React/HTML, <em>border-radius</em> can be defined in percentages (in addition to pixels, other units)
            whereas React Native does not support percentage values.</p>
...
fontWeight: 500
            ...
            <p>In React Native, borders can only be defined in separate style attributes: <em>borderStyle</em>, <em>borderWidth</em>, <em>borderColor</em>.
            In React/HTML, the three border attributes can be both separate and combined.</p>
...
paddingLeft: 4
            ...
            <p>React Native, however, offers special horizontal and vertical combined padding and margins using
            <em>paddingHorizontal</em>, <em>paddingVertical</em>, <em>marginHorizontal</em>, <em>marginVertical</em> respectively.</p> 
...
paddingLeft: 2
            ...
            <p>Although there exist these minor syntactical discrepencies between React and React Native, these differences should not impose a major obstacle
            for the transposition from React to React Native as component and styling syntaxes remaining relatively the same.
            ...
            <br /><a target="_blank" href="https://developer.mozilla.org/en-US/docs/Web/CSS/CSS_Flexible_Box_Layout/Basic_Concepts_of_Flexbox">https://developer.mozilla.org/en-US/docs/Web/CSS/CSS_Flexible_Box_Layout/Basic_Concepts_of_Flexbox</a></p>
